    ...
    {:else}
        ...
        <div class="bg-base-100 shadow-lg rounded-lg p-6 mb-6">
            <div class="flex flex-col gap-4">
                <div class="flex flex-col gap-2">
                    <h1 class="text-2xl font-bold text-base-content">Pool Details</h1>
                    <div class="flex flex-wrap items-center gap-4">
                        ...
                        <div class="flex items-center gap-2">
                            <span class="text-base-content/60">Epoch:</span>
                            <span class="font-medium text-base-content/80">{data.pool.epoch}</span>
                        </div>
                    </div>
                </div>
                <div class="flex flex-col gap-2">
                    <span class="text-base-content/60">Pool ID:</span>
                    <div class="flex items-center gap-2 bg-base-200 p-3 rounded">
                        <span class="font-mono text-base-content/80 truncate" title={data.pool.pool_id}>{data.pool.pool_id}</span>
                        <button 
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="bg-base-100 shadow-lg rounded-lg p-6">
                ...
                <div class="space-y-4">
                    <div class="flex items-center gap-2">
                        <span class="text-base-content/60 w-32">Pool Hash:</span>
                        <span class="font-mono text-base-content/80 truncate flex-1" title={data.pool.pool_hash}>{data.pool.pool_hash}</span>
                        <button 
                            class="text-base-content/50 hover:text-base-content/70 transition-colors duration-150 flex-shrink-0" 
                    ...
                    <div class="flex items-center gap-2">
                        <span class="text-base-content/60 w-32">VRF Key Hash:</span>
                        <span class="font-mono text-base-content/80 truncate flex-1" title={data.pool.vrf_key_hash}>{data.pool.vrf_key_hash}</span>
                        <button 
                            class="text-base-content/50 hover:text-base-content/70 transition-colors duration-150 flex-shrink-0" 
            ...
            <div class="bg-base-100 shadow-lg rounded-lg p-6">
                ...
                <div class="space-y-4">
                    <div class="flex items-center gap-2">
                        <span class="text-base-content/60 w-32">Pledge:</span>
                        <span class="font-medium text-base-content/80 flex-1" title="{data.pool.pledge} lovelace">{formatAda(data.pool.pledge)} ADA</span>
                    </div>
                    <div class="flex items-center gap-2">
                        <span class="text-base-content/60 w-32">Cost:</span>
                        <span class="font-medium text-base-content/80 flex-1" title="{data.pool.cost} lovelace">{formatAda(data.pool.cost)} ADA</span>
                    </div>
                    <div class="flex items-center gap-2">
                        <span class="text-base-content/60 w-32">Margin:</span>
                        <span class="font-medium text-base-content/80 flex-1">{(parseFloat(data.pool.margin) * 100).toFixed(2)}%</span>
                    </div>
                    <div class="flex items-center gap-2">
                        <span class="text-base-content/60 w-32">Reward Account:</span>
                        <span class="font-mono text-base-content/80 truncate flex-1" title={data.pool.reward_account}>{data.pool.reward_account}</span>
                        <button 
                            class="text-base-content/50 hover:text-base-content/70 transition-colors duration-150 flex-shrink-0" 
            ...
            <div class="bg-base-100 shadow-lg rounded-lg p-6">
                ...
                <div class="space-y-3">
                    {#each data.pool.pool_owners as owner}
                        <div class="flex items-center gap-2 bg-base-200 p-3 rounded">
                            <span class="font-mono text-base-content/80 truncate flex-1" title={owner}>{owner}</span>
                            <button 
                                class="text-base-content/50 hover:text-base-content/70 transition-colors duration-150 flex-shrink-0" 
                    ...
                    {#each data.pool.relays as relay}
                        <div class="bg-base-200 p-4 rounded-lg">
                            <div class="flex items-center gap-2 mb-2">
                                <span class="text-base-content/60">DNS Name:</span>
                                <span class="font-medium text-base-content/80 truncate flex-1" title={relay.dnsName}>{relay.dnsName}</span>
                                <button 
                                    class="text-base-content/50 hover:text-base-content/70 transition-colors duration-150 flex-shrink-0" 
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <span class="font-medium text-base-content/80">{relay.port}</span>
                            </div>
                        </div>
                    {/each}
                </div>
            ...
            <div class="bg-base-100 shadow-lg rounded-lg p-6">
                ...
                <div class="space-y-4">
                    <div class="flex items-center gap-2">
                        <span class="text-base-content/60 w-32">URL:</span>
                    ...
                    <div class="flex items-center gap-2">
                        <span class="text-base-content/60 w-32">Hash:</span>
                        <span class="font-mono text-base-content/80 truncate flex-1" title={data.pool.metadata_hash}>{data.pool.metadata_hash}</span>
                        <button 
                            class="text-base-content/50 hover:text-base-content/70 transition-colors duration-150 flex-shrink-0" 

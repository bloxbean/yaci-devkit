...
import static com.bloxbean.cardano.yacicli.commands.localcluster.ClusterConfig.NODE_BP_SCRIPT;
import static com.bloxbean.cardano.yacicli.commands.localcluster.ClusterConfig.NODE_RELAY_SCRIPT;
import static com.bloxbean.cardano.yacicli.commands.localcluster.peer.ClusterAdminClient.waitForTxToComplete;
...
//            SecretKey paymentSecretKey = poolKeyGeneratorService.getSecretKey(nodeName, "payment.skey").orElseThrow();
            ...
            if (result.isSuccessful()) {
                ...
                if (waitForTxToComplete(utxoSupplier, addr, result.getValue(), writer))
